...
.btn {
	...
	border: 1px solid #95B8E7;
		...
		<form action="" method="post" id="stocksForm" name="stocksForm">
			<table width="500" height="198" id="stocksTable" align="center" class="datalist"
				style="margin: 10px auto;">
				  ...
				  <tr class="altrow">
					<td colspan="2">说明</td>
					<td colspan="6"> ${stocks.remark }</td>
				  </tr>
				  <tr>
					<td colspan="2">部长是否同意</td>
					<td colspan="6"> ${stocks.leadAgree }</td>
				  </tr>
				  <tr class="altrow">
					<td colspan="2">部长审核意见</td>
					<td colspan="6"> ${stocks.leadOpinion }</td>
				  </tr>
			</table>
		</form>
	</body>
