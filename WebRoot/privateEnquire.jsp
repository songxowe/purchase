...
<html>
  ...
  <body>
    <div style="margin: 10px 30px;">
      ...
      <!-- 雇员列表的工具栏设置 -->
      <div id="searchPrivateEnquireForm" style="padding: 10px;">
      ...
      <div style="margin-top: 20px;">
        <table id="privateEnquireDataGrid">
  ...
  $(function() {
    enquire_obj = {
      search : function() {
        $("#privateEnquireDataGrid").datagrid(
            "load",
            {
    ...
    $("#privateEnquireDataGrid").datagrid( {
      url : "quoteController_enquireList?stockType=C000-2&userId="+${sessionScope["NEWER_USER_LOGIN_INFO"].id},
      title : "定向询价书列表",
      fitColumns : true,
      singleSelect : true,
      striped : true,
      ...
      toolbar : "#searchPrivateEnquireForm",
      pagination : true,
      pageSize : 5,
